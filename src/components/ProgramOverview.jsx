    ...
    <div className={className}>
      ...
      <div className="border-b-2 pb-8">
        ...
        <ul className="list-disc pl-4">
          <li>
            <a href="/downloads/DCCN2022_program_overview.pdf" target="_blank" className="text-blue-500 hover:underline">
              <FontAwesomeIcon icon={faFilePdf} size="lg" className="mr-2 text-purple-500"/>DCCN2022_program_overview.PDF
            </a>
